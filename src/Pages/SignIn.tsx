            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 gap-4 max-w-md mx-auto">
                ...
                <div className="flex items-center p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                  ...
                  <div className="text-left">
                    <p className="text-white font-medium">Quality Services</p>
                    <p className="text-gray-400 text-sm">Rated by community</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-md">
              ...
              <div className="bg-black/20 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/10 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                  ...
                  >
                    <div className="w-full flex items-center justify-center px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed group-hover:scale-[1.02]">
                      {isLoading ? (
                        <>
